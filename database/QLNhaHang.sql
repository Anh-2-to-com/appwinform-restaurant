...
--insert into QL_NhomNguoiDung values('QL', N'Quản lý', '')
--insert into QL_NhomNguoiDung values('NV', N'Nhân viên', '')
--insert into QL_NhomNguoiDung values('NVK', N'Nhân viên kho', '')

--insert into NGUOIDUNG values('ND001', 'admin@gmail.com', '123456', 'Quan ly')
--insert into NGUOIDUNG values('ND002', 'khiem@gmail.com', '123456', 'Nhan vien')

--insert into QL_NguoiDungNhomNguoiDung values('QL', 'ND001', '')
--insert into QL_NguoiDungNhomNguoiDung values('NV', 'ND002', '')

--insert into DM_ManHinh values('MH001', N'Quản lý người dùng')
--insert into DM_ManHinh values('MH002', N'Quản lý bàn')
--insert into DM_ManHinh values('MH003', N'Quản lý món ăn')

--insert into QL_PhanQuyen values('QL', 'MH001', 1)
--insert into QL_PhanQuyen values('QL', 'MH002', 1)
--insert into QL_PhanQuyen values('QL', 'MH003', 1)
--insert into QL_PhanQuyen values('NV', 'MH001', 0)
--insert into QL_PhanQuyen values('NV', 'MH002', 1)
--insert into QL_PhanQuyen values('NV', 'MH003', 1)
...
GO
-----Tao bảng QL_NhomNguoiDung
create table QL_NhomNguoiDung(
    MaNhom varchar(10),
    TenNhom nvarchar(50),
    GhiChu nvarchar(50),
    constraint PK_QL_NhomNguoiDung primary key(MaNhom)
)
GO
-----Tao bảng QL_NguoiDungNhomNguoiDung
create table QL_NguoiDungNhomNguoiDung(
    MaNhomNguoiDung varchar(10),
    ID_ND VARCHAR(16),
    GhiChu nvarchar(50),
    constraint PK_QL_NguoiDungNhomNguoiDung primary key(ID_ND, MaNhomNguoiDung)
)
GO

-----Tao bảng QL_PhanQuyen
...
GO
ALTER TABLE NGUOIDUNG ADD HOATDONG BIT
GO
...
alter table NHANVIEN
add constraint chk_NHANVIEN_TINHTRANG check (TINHTRANG IN (N'Đang làm việc', N'Đã nghỉ việc'));
GO
...
add constraint FK_NguoiDungNhomNguoiDung_NGUOIDUNG foreign key(ID_ND) references NGUOIDUNG(ID_ND)

alter table QL_NguoiDungNhomNguoiDung
add constraint FK_NguoiDungNhomNguoiDung_NhomNguoiDung foreign key(MaNhomNguoiDung) references QL_NhomNguoiDung(MaNhom)

------------Khoa ngoai QL_PhanQuyen
alter table QL_PhanQuyen
add constraint FK_PhanQuyen_NhomNguoiDung foreign key(MaNhomNguoiDung) references QL_NhomNguoiDung(MaNhom)

alter table QL_PhanQuyen
add constraint FK_PhanQuyen_ManHinh foreign key(MaManHinh) references DM_ManHinh(MaManHinh)
